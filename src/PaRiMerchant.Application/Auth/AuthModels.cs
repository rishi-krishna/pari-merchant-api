...
public sealed record UnlockMpinRequest(string Mpin);
...
public sealed record UpdateMpinRequest(string OldMpin, string NewMpin, string ConfirmMpin);
public sealed record UpdateProfileRequest(string DisplayName, string Email, string Phone);
public sealed record UserProfile(string UserId, string TenantId, string MerchantCode, string Role, string DisplayName, string Phone, string Email);
